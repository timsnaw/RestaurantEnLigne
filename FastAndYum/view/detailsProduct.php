...
<body>
 ...
 <div class="container py-5 wow fadeInUp" data-wow-delay="0.1s">
    <form method="POST" action="panier.php"> 
        <div class="row">
            <div class="col-md-6">
                <img id="mainImage" src="/FastAndYumProject/FastAndYum/public/img/burger.jpg" class="product-image wow fadeInUp" data-wow-delay="0.2s" alt="Burger">
                <div class="d-flex mt-3">
                    <img src="/FastAndYumProject/FastAndYum/public/img/burger.jpg" class="thumb-img wow fadeInUp" data-wow-delay="0.2s" onclick="changeImage(this.src)">
                    <img src="/FastAndYumProject/FastAndYum/public/img/burger.jpg" class="thumb-img wow fadeInUp" data-wow-delay="0.3s" onclick="changeImage(this.src)">
                    <img src="/FastAndYumProject/FastAndYum/public/img/burger.jpg" class="thumb-img wow fadeInUp" data-wow-delay="0.4s" onclick="changeImage(this.src)">
                </div>
            </div>
            <div class="col-md-6">
        ...
        <label class="option-extra">
           ...
           <input type="checkbox" name="extras[]" value="soda">
                ...
                <div class="mt-4 d-flex gap-3">
                    ...
                    <button type="submit" name="action" value="panier" class="btn btn-outline-danger px-4">Ajouter au panier</button>
                </div>
            </div>
        </div>
    </form>
