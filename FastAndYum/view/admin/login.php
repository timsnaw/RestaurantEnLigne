...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" href="/FastAndYumProject/FastAndYum/public/img/logo1.png" />

  <!-- Bootstrap CSS -->
  <link href="/FastAndYumProject/FastAndYum/public/css/bootstrap.min.css" rel="stylesheet" />

  <!-- Custom CSS -->
  <link href="/fastandyam/FastAndYum/public/css/admin/admin_login.css" rel="stylesheet" />
</head>
<body>
  <div class="login-container d-flex justify-content-center align-items-center">
    <div class="login-box shadow-lg p-4 rounded bg-white">
      <div class="text-center mb-4">
        <img src="/FastAndYumProject/FastAndYum/public/img/logo1.png" alt="Fast&Yum Logo" class="login-logo mb-3">
