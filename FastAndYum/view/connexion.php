...
<link href="/FastAndYumProject/FastAndYum/public/img/logo1.png" rel="icon">
    ...
    <link href="/FastAndYumProject/FastAndYum/public/css/authentification.css" rel="stylesheet">
  ...
  <div class="card glass-card mx-auto overflow-hidden" style="max-width: 750px;">
    <div class="row g-0 w-100">
      ...
      <div class="col-md-6 d-none d-md-block p-0">
        <img src="/FastAndYumProject/FastAndYum/public/img/chawarma.jpg" alt="Login Image" class="w-100 img-left">
      </div>

      <!-- Colonne formulaire -->
      <div class="col-md-6 bg-white p-4 d-flex flex-column justify-content-center">
         <img src="/FastAndYumProject/FastAndYum/public/img/logoprincipale3D.png" alt="Logo" style="width: 50px; margin-bottom: 10px;" class="mx-auto d-block">
...
<!---->
        <form method="POST" action="index.php?url=login">
          ...
          <p class="mt-3 text-center small">Pas encore inscrit ?
            <a href="index.php?url=register" class="text-decoration-none text-warning fw-bold">Créer un compte</a>
          </p>
        </form>
      </div>
    </div>
