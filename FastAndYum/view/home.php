        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="/FastAndYumProject/FastAndYum/public/img/burgerlast.jpg" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="/FastAndYumProject/FastAndYum/public/img/pizzalast.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <a class="btn btn-primary py-3 px-5 mt-3" href="index.php?url=apropos"
...
<section class="py-5" style="background: linear-gradient(135deg, #fef9f1, #fff1d0);">
  ...
  <div class="container">
    <div class="row g-4 justify-content-center align-items-center">
      ...
      <div class="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
        <div class="p-4 bg-light rounded-4 shadow-sm text-center" style="border-radius: 20px;">
          <img src="/FastAndYumProject/FastAndYum/public/img/fastdelevry.png" alt="Livraison rapide"
    ...
    <section class="promo-section">
        <a href="index.php?url=menu" class="promo-button">Order Now</a>
    </section>
    <!--end promo-->
